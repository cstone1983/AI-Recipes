                    ...
                    {(viewingRecipe.calories || viewingRecipe.protein || viewingRecipe.carbs || viewingRecipe.fat) && (
                      <div className="flex justify-center py-4">
                        <div className="nutrition-facts-label p-5 border-2 border-black w-full max-w-[320px] font-sans shadow-2xl mx-auto">
                          ...
                          <div className="flex justify-between items-end border-b-[10px] border-black py-1">
                            <div className="font-black text-xl">Serving size</div>
                            <div className="font-black text-xl">1 serving</div>
                          </div>
                          
                          <div className="flex justify-between items-baseline py-2 border-b border-black">
                            <div className="flex flex-col">
                              <div className="font-black text-xs uppercase tracking-tight">Amount per serving</div>
                              <div className="font-black text-3xl leading-none">Calories</div>
                            </div>
                            <div className="font-black text-5xl leading-none">{viewingRecipe.calories || 0}</div>
                          </div>

                          <div className="text-right text-[10px] font-black py-1 border-b-2 border-black">% Daily Value*</div>
                          
                          <div className="flex justify-between border-b border-zinc-400 py-1 text-sm">
                          ...
                          <div className="flex justify-between border-b border-zinc-400 py-1 text-sm pl-4">
                          ...
                          <div className="border-b border-zinc-400 py-1 text-sm pl-4 italic">
                          ...
                          <div className="border-b border-zinc-400 py-1 text-sm pl-4">
                            Total Sugars {viewingRecipe.sugar || 0}g
                          </div>
                          <div className="flex justify-between border-b border-zinc-400 py-1 text-sm pl-8">
                          ...
                          <div className="border-b-[10px] border-black py-1 text-sm">
                            <span className="font-black">Protein</span> {viewingRecipe.protein || 0}g
                          </div>

                          <div className="border-b border-zinc-400 py-1 text-sm flex justify-between">
                          ...
                          <div className="border-b-4 border-black py-1 text-sm flex justify-between">
                            <div>Potassium {viewingRecipe.potassium || 0}mg</div>
                            <div>{Math.round(((viewingRecipe.potassium || 0) / 4700) * 100)}%</div>
                          </div>

                          <div className="text-[9px] leading-tight pt-2 italic">
